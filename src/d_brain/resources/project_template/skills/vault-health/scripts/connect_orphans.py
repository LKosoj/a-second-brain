...
HUB_MAP = [
    # MOC-plaud.md and MOC-weekly.md are neither shipped in the vault
    # template nor generated by generate_moc.py, so linking to them here
    # created a broken link that fix_links.py then removed every night
    # (ping-pong). MOC/index.md is the one hand-curated hub guaranteed to
    # exist, so these two categories point there instead.
    ("imports/plaud/notes/", '[[MOC/index]]'),
    ("summaries/", '[[MOC/index]]'),
